...
# 2. Apply the base theme and modify specific elements
plot_grid(
    population_pyramid + 
        base_theme +
        labs(y=NULL)+
...
##
if(grepl("ubuntu",system_r_platform())){
  ggsave(paste0(wdpath,"/_figs/pyramid_congresosp.png"), dpi = 600, width = 9*1.6, height=4)
} else {
  ggsave(paste0(wdpath,"/cons/_figs/pyramid_congresosp.png"), dpi = 600, width = 9*1.6, height=4)
}
```
